...
import expenseRegisterData from "@/data/beapOneLite/expenseRegisterData.json";
...
export async function GET(req) {
  ...
  if (!section) {
    ...
    return NextResponse.json(expenseRegisterData);
  }

  if (Object.prototype.hasOwnProperty.call(expenseRegisterData, section)) {
    const dataSection = expenseRegisterData[section];
