...
import reportingEngineData from "@/data/beapOneLite/reportingEngineData.json";
...
export async function GET(req) {
  ...
  if (!section) {
    ...
    return NextResponse.json(reportingEngineData);
  }

  if (Object.prototype.hasOwnProperty.call(reportingEngineData, section)) {
    const dataSection = reportingEngineData[section];
