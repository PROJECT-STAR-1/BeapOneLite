...
import salesManagementData from "@/data/beapOneLite/salesManagementData.json";
...
export async function GET(req) {
  ...
  if (!section) {
    ...
    return NextResponse.json(salesManagementData);
  }

  if (Object.prototype.hasOwnProperty.call(salesManagementData, section)) {
    const dataSection = salesManagementData[section];
