...
import documentData from "@/data/beapOneLite/documentData.json";
...
export async function GET(req) {
  ...
  if (Object.prototype.hasOwnProperty.call(documentData, section)) {
    const dataSection = documentData[section];
