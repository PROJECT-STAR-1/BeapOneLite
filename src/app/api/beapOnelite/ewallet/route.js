...
import ewalletData from "@/data/beapOneLite/ewalletData.json";
...
export async function GET(req) {
  ...
  if (Object.prototype.hasOwnProperty.call(ewalletData, section)) {
    const dataSection = ewalletData[section];
