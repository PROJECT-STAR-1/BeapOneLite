...
import expenseDashboardData from "@/data/beapOneLite/expenseDashboardData.json";
...
export async function GET(req) {
  ...
  if (!section) {
    ...
    return NextResponse.json(expenseDashboardData);
  }

  if (Object.prototype.hasOwnProperty.call(expenseDashboardData, section)) {
    const dataSection = expenseDashboardData[section];
