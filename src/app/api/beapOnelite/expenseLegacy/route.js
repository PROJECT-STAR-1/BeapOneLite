...
import expenseLegacyData from "@/data/beapOneLite/expenseLegacyData.json";
...
export async function GET(req) {
  ...
  if (!section) {
    ...
    return NextResponse.json(expenseLegacyData);
  }

  if (Object.prototype.hasOwnProperty.call(expenseLegacyData, section)) {
    const dataSection = expenseLegacyData[section];
