...
import projectData from "@/data/beapOneLite/projectData.json";
...
export async function GET(req) {
  ...
  if (Object.prototype.hasOwnProperty.call(projectData, section)) {
    const dataSection = projectData[section];
